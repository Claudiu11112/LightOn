...
//                e.printStackTrace();
    ...
    private void initialize() {
       ...
       // assert url != null;
        ...
        JButton btnOn = getBtnOn(lbl3);
        f.getContentPane().add(btnOn);

        JButton btnOff = getBtnOff(lbl3);
        ...
        JButton btnOff1 = getBtnOff1(lbl4);
        f.getContentPane().add(btnOff1);

        JButton btnOn1 = getBtnOn1(lbl4);
    ...
    private static JButton getBtnOn1(JLabel lbl4) {
    ...
    private static JButton getBtnOff1(JLabel lbl4) {
    ...
    private static JButton getBtnOff(JLabel lbl3) {
    ...
    private static JButton getBtnOn(JLabel lbl3) {
